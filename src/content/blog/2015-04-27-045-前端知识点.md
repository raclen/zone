---
title: "前端知识点"
description: "简述一个标准事件模型和IE事件模型 下面代码会输出 将字符串中的敏感词标红 例子：字符串为\"中共十六大评出习近平为领导在6.4日\"，敏感词习近平，6.4 jquery 的$.fn.extend实现 设置基于观察者模式的时间机制 这个也就是自定义事件吧 indexof的用法 原来数组和字符串都有这个方..."
pubDate: 2015-04-27T16:00:00.000Z
issueNumber: 45
issueUrl: https://github.com/raclen/zone/issues/45
tags: ["legacy", "工具", "面试"]
author:
  name: "raclen"
...
```
### 将字符串中的敏感词标红
例子：字符串为"中共十六大评出习近平为领导在6.4日"，敏感词习近平，6.4
```javascript
"中共十六大评出习近平为领导在6.4日".replace(/6\.4|习近平/g,function(){
...
### jquery 的$.fn.extend实现
[再来看看$.extend](http://muxu.farbox.com/post/javascript/zai-lai-kan-kan-$.extend)
### 设置基于观察者模式的时间机制
这个也就是自定义事件吧
[JavaScript常问代码片段](http://muxu.farbox.com/post/gong-ju/javascriptchang-wen-dai-ma-pian-duan)
### indexof的用法
...
![](https://raw.githubusercontent.com/raclen/raclen.github.io/master/blog-assets/%E5%89%8D%E7%AB%AF%E7%9F%A5%E8%AF%86%E7%82%B9/14-12-46.jpg)

IE盒子模型

![](https://raw.githubusercontent.com/raclen/raclen.github.io/master/blog-assets/%E5%89%8D%E7%AB%AF%E7%9F%A5%E8%AF%86%E7%82%B9/14-08-31.jpg)
...
### 你所知道的http状态码
404,200,502,403.。。。
[http相关知识](http://muxu.pw/post/wei-fen-lei/httpxiang-guan-zhi-shi)
###  ajax工作原理，如何跨域
这个人写的很好， 一看就懂
...
###你有什么要问我的
你们这次招人的侧重方向，主要涉及哪些业务，运用什么技术，有多少开发
相关内容
[这里有超过20家的前端面试题](http://www.jianshu.com/p/8b68f4df749e)
[Angular面试从喜剧到悲剧的十个问题](https://segmentfault.com/a/1190000005817928#articleHeader4)
[简历筛选经验总结](https://ijser.cn/2017-07-16-resume-selecting-experance/)
