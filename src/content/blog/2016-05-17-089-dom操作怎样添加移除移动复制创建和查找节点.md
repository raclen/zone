...
description: "1. 创建新节点       createDocumentFragment()    //创建一个DOM片段       createElement()   //创建一个具体的元素       createTextNode()   //创建一个文本节点 2. 添加、移除、替换、插入       ap..."
pubDate: 2016-05-17T05:49:00.000Z
issueNumber: 89
issueUrl: https://github.com/raclen/zone/issues/89
...
```javascript
 ...
 ```
 原文地址[节点的操作 创建、添加、移除、移动、复制](http://www.cnblogs.com/dtdxrk/archive/2012/06/19/2554926.html)
