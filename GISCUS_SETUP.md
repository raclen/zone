...
1. 访问你的仓库：`https://github.com/raclen/raclen.github.io`
2. 点击 **Settings** 标签
3. 找到 **Features** 区域
4. 勾选 **Discussions**
...
2. 点击 **Install**
3. 选择你的仓库 `raclen/raclen.github.io`
...
编辑 `src/pages/blog/_components/GiscusComments.astro`，替换以下两行：
...
编辑 `GiscusComments.astro` 可以调整：
- `data-reactions-enabled="1"` - 是否启用表情反应
...
- GitHub Discussions：https://github.com/raclen/raclen.github.io/discussions
